...
def CNN_1(loss,metrics,lr,image_shape,number_labels):     
    model = Sequential()
...
def CNN_2(loss,metrics,lr,image_shape,number_labels):          
    model = Sequential()
...
def CNN_3(loss,metrics,lr,image_shape,number_labels):   
    model = Sequential()
